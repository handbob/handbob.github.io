 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,j){var Q=D.length;D.push(j);e:for(;0<Q;){var oe=Q-1>>>1,ye=D[oe];if(0<r(ye,j))D[oe]=j,D[Q]=ye,Q=oe;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var j=D[0],Q=D.pop();if(Q!==j){D[0]=Q;e:for(var oe=0,ye=D.length,Be=ye>>>1;oe<Be;){var V=2*(oe+1)-1,ne=D[V],de=V+1,ue=D[de];if(0>r(ne,Q))de<ye&&0>r(ue,ne)?(D[oe]=ue,D[de]=Q,oe=de):(D[oe]=ne,D[V]=Q,oe=V);else if(de<ye&&0>r(ue,Q))D[oe]=ue,D[de]=Q,oe=de;else break e}}return j}function r(D,j){var Q=D.sortIndex-j.sortIndex;return Q!==0?Q:D.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,h=null,d=3,p=!1,v=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(D){for(var j=n(c);j!==null;){if(j.callback===null)i(c);else if(j.startTime<=D)i(c),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(c)}}function E(D){if(x=!1,g(D),!v)if(n(l)!==null)v=!0,W(P);else{var j=n(c);j!==null&&K(E,j.startTime-D)}}function P(D,j){v=!1,x&&(x=!1,u(L),L=-1),p=!0;var Q=d;try{for(g(j),h=n(l);h!==null&&(!(h.expirationTime>j)||D&&!b());){var oe=h.callback;if(typeof oe=="function"){h.callback=null,d=h.priorityLevel;var ye=oe(h.expirationTime<=j);j=t.unstable_now(),typeof ye=="function"?h.callback=ye:h===n(l)&&i(l),g(j)}else i(l);h=n(l)}if(h!==null)var Be=!0;else{var V=n(c);V!==null&&K(E,V.startTime-j),Be=!1}return Be}finally{h=null,d=Q,p=!1}}var A=!1,w=null,L=-1,T=5,y=-1;function b(){return!(t.unstable_now()-y<T)}function G(){if(w!==null){var D=t.unstable_now();y=D;var j=!0;try{j=w(!0,D)}finally{j?B():(A=!1,w=null)}}else A=!1}var B;if(typeof _=="function")B=function(){_(G)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,$=q.port2;q.port1.onmessage=G,B=function(){$.postMessage(null)}}else B=function(){m(G,0)};function W(D){w=D,A||(A=!0,B())}function K(D,j){L=m(function(){D(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,W(P))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(d){case 1:case 2:case 3:var j=3;break;default:j=d}var Q=d;d=j;try{return D()}finally{d=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,j){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var Q=d;d=D;try{return j()}finally{d=Q}},t.unstable_scheduleCallback=function(D,j,Q){var oe=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?oe+Q:oe):Q=oe,D){case 1:var ye=-1;break;case 2:ye=250;break;case 5:ye=1073741823;break;case 4:ye=1e4;break;default:ye=5e3}return ye=Q+ye,D={id:f++,callback:j,priorityLevel:D,startTime:Q,expirationTime:ye,sortIndex:-1},Q>oe?(D.sortIndex=Q,e(c,D),n(l)===null&&D===n(c)&&(x?(u(L),L=-1):x=!0,K(E,Q-oe))):(D.sortIndex=ye,e(l,D),v||p||(v=!0,W(P))),D},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(D){var j=d;return function(){var Q=d;d=j;try{return D.apply(this,arguments)}finally{d=Q}}}})(Kp);$p.exports=Kp;var nv=$p.exports;/**
 * @license React
...
`)+`
`+u);const g=_+m+o,E=_+u+a,P=wp(r,r.VERTEX_SHADER,g),A=wp(r,r.FRAGMENT_SHADER,E);r.attachShader(x,P),r.attachShader(x,A),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function w(b){if(t.debug.checkShaderErrors){const G=r.getProgramInfoLog(x).trim(),B=r.getShaderInfoLog(P).trim(),q=r.getShaderInfoLog(A).trim();let $=!0,W=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if($=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,P,A);else{const K=Ap(r,P,"vertex"),D=Ap(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
